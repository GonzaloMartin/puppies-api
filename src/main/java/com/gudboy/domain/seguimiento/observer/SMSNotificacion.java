...
public class SMSNotificacion implements IObservador {
    ...
    public void enviarRecordatorio(Visita visita) {
        ...
        com.gudboy.infrastructure.ActividadRegistry.publicar("[Observer SMS] Activado para visita programada el " + visita.getFechaProgramada() + " (Mascotas: " + nombresMascotas + ").");
